...
class GeneratorTest {
    ...
    void testCR() {
        // Arrange
        JCRObject cro = new JCRObject("v1alpha1", "t", "g", "v", true, true, true, true);
    ...
    void testCRWithoutNamespace() {
        // Arrange
        JCRObject cro = new JCRObject(null, "t", "g", "v", true, true, true, true);
    ...
    void testEmptyObject() {
        // Arrange
        JObject obj = new JObject("v1alpha1", "t", null, null, false, "");
    ...
    void testEmptyObjectWithoutNamespace() {
        // Arrange
        JObject obj = new JObject(null, "t", null, null, false, "");
    ...
    void testObjectOfPrimitives() {
        ...
        JObject obj = new JObject("v1alpha1", "t", props, null, false, "");
    ...
    void testObjectWithRequiredField() {
        ...
        req.add("o1");
        JObject obj = new JObject("v1alpha1", "t", props, req, false, "");
    ...
    void testArrayOfObjects() {
        // Arrange
        JArray array = new JArray(new JObject(null, "t", null, null, false, ""));
    ...
    void testMapOfObjects() {
        // Arrange
        JMap map = new JMap(new JObject(null, "t", null, null, false, ""));
    ...
    void testObjectOfObjects() {
        ...
        props.put("o1", newObj);
        JObject obj = new JObject(null, "t", props, null, false, "");
    ...
    void testObjectWithPreservedFields() {
        // Arrange
        JObject obj = new JObject(null, "t", null, null, true, "");
